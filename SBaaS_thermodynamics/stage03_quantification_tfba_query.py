...
class stage03_quantification_tfba_query(sbaas_template_query):
    ...
    def get_rowsEscher_experimentIDAndModelIDAndSampleNameAbbreviations_dataStage03QuantificationSampledData(self,experiment_id_I,model_id_I,sample_name_abbreviation_I):
        ...
        try:
            ...
            print(e);
    def add_dataStage03QuantificationSampledData(self, data_I):
        '''add rows of data_stage03_quantification_sampledData'''
        if data_I:
            for d in data_I:
                try:
                    data_add = data_stage03_quantification_sampledData(d
                        );
    ...
    def get_rows_simulationID_dataStage03QuantificationSampledPoints(self,simulation_id_I):
        ...
        try:
            ...
            print(e);
    def add_dataStage03QuantificationSampledPoints(self, data_I):
        '''add rows of data_stage03_quantification_sampledPoints'''
        if data_I:
            for d in data_I:
                try:
                    data_add = data_stage03_quantification_sampledPoints(d
                        );
                    self.session.add(data_add);
                except SQLAlchemyError as e:
                    print(e);
